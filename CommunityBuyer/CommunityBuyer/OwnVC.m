...
-(void)makeNewData
{
    ...
    NSArray *itemY=@[ [UIImage imageNamed:@"my_order"] ,@"我的卡券" ];
    _mallsel[i++][j] = @selector(goMyOrderClick);
    NSMutableArray *itemArr=[[NSMutableArray alloc] initWithObjects:item,itemY, nil];
