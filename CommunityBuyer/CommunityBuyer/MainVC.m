...
-(void)mainBtnTouched:(CustomBtn *)sender
{
    ...
    switch (func.mType) {
        ...
        case 1://商户类型
        {
            ...
            NSLog(@"<[func.mArg intValue]===%d><func.mType===%d><func.mName==%@>",[func.mArg intValue],func.mType,func.mName);
            if([func.mArg intValue]==10){
                [SVProgressHUD showWithStatus:@"加载中.." maskType:SVProgressHUDMaskTypeClear];
            ...
            } else if([func.mArg intValue]==42){
                [SVProgressHUD showWithStatus:@"加载中.." maskType:SVProgressHUDMaskTypeClear];
                [SSeller getAllSeller:0 page:1 type:42 keyword:nil  block:^(SResBase *info, NSArray *all) {
