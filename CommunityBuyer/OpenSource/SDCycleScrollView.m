...
- (void)layoutSubviews
{
    ...
    _pageControl.frame = CGRectMake(x+40, y+20, size.width, size.height);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //cell.imageView.image = //self.imagesGroup[itemIndex]; [cell.imageView setImageWithURL:[NSURL URLWithString:self.imagesGroup[itemIndex]] placeholderImage:[UIImage imageNamed:@"icon_nopic"]];
    cell.imageView.contentMode = UIViewContentModeScaleAspectFit;
    [cell.imageView setImageWithURL:[NSURL URLWithString:[Util makeImgUrl:self.imagesGroup[itemIndex] tagImg:cell.imageView]] placeholderImage:[UIImage imageNamed:@"icon_nopic"]];
